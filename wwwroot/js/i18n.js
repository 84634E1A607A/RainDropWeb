class i18n {
    ...
    static English = {
        ...
        "site-msg-io-error": "Rain drop has experienced an IO error. Check the device status and try to reconnect in Home tab. You may need to completely power-off the device and re-power-on",
