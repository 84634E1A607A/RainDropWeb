...
public static class Localization
{
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        {"INVALID_WAVE_FREQUENCY", "Invalid wave generator frequency."},
        {"INVALID_WAVE_OFFSET", "Invalid wave generator offset."},
        {"INVALID_WAVE_AMP", "Invalid wave generator amplitude."},
        {"INVALID_WAVE_SYM" , "Invalid wave generator symmetry."},
        {"FREQUENCY_UNFIT", "Frequency must be between 0 and 40 MHz."},
        {"SYM_UNFIT","Symmetry must be between 0 and 1." },
        {"ZERO_LENGTH", "must have an even length." },
        {"NEGTIVE_VOL_ERR", "Negative channel voltage should be between -5 and 0." },
        {"POSITIVE_VOL_ERR", "Positive channel voltage should be between 0 and 5." },
        {"SIZE_ERR", "Size should be 32, 64, 128, 256, 512, 1024 or 2048." },
        {"LEVEL_OUT_OF_RANGE_1", "Level " },
        {"LEVEL_OUT_OF_RANGE_2", " must be in range " },
        {"LEVEL_OUT_OF_RANGE_3", "." },
        {"DEVICE_QUERY_ERR", "Error querying number of devices: " },
        {"DEVICE_LIST_ERR", "Error when getting devices list: " },
        {"DEVICE_OPEN_YET", "A device is already open." },
        {"RANGE_OUT_OF_RANGE", "Range must be 5 or 25." },
        {"FREQUENCY_OUT_OF_RANGE", "Frequency must be between 1 and 40MHz." },
        {"DATA_RANGE_ERR", "Data points must be 32, 64, 128, 256, 512, 1024 or 2048." },
    ...
    private static readonly Dictionary<string, string> Chinese = new()
    {
        ...
        {"FREQUENCY_UNFIT", "频率必须介于0到40兆赫兹之间。"},
        {"SYM_UNFIT","对称度必须介于0到1之间。" },
        {"ZERO_LENGTH", "必须要有一个确定的长度。" },
        {"NEGTIVE_VOL_ERR", "负电压必须设置在-5到0之间。" },
        {"POSITIVE_VOL_ERR", "正电压必须设置在0到5之间。" },
        {"SIZE_ERR", "值的大小必须为32，64，128，256，514，1024，2048其中之一。" },
        {"LEVEL_OUT_OF_RANGE_1", "设定的电压" },
        {"LEVEL_OUT_OF_RANGE_2", "必须在" },
        {"LEVEL_OUT_OF_RANGE_3", "范围内。" },
        {"DEVICE_QUERY_ERR", "查询设备数量错误：" },
        {"DEVICE_LIST_ERR", "获取设备列表时出错：" },
        {"DEVICE_OPEN_ERR", "已经打开了一个设备。" },
        {"RANGE_OUT_OF_RANGE", "极值应当设置为5或25。" },
        {"FREQUENCY_OUT_OF_RANGE", "频率应当设置在1到40兆赫兹之间。" },
        {"DATA_RANGE_ERR", "采样比应当设置为32，64，128，256，514，1024，2048其中之一。" },
